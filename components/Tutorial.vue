    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="p-6 mt-8 overflow-hidden bg-white shadow sm:rounded-lg">
        ...
        <p class="pt-4 mt-4 text-gray-800 border-t border-dashed">
          ...
          <code class="p-1 text-sm bg-gray-100 border rounded"
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a v-touch href="https://github.com/nuxt/nuxt.js" target="_blank"
          ><svg
          ...
          >
            ...
            /></svg
        ></a>
        <a v-touch href="https://twitter.com/nuxt_js" target="_blank"
          ><svg
